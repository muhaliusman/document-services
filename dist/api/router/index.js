...
router.get("/document-service", [_auth["default"].required], _documentController["default"].getAll);
...
router.get("/document-service/folder/:id", [_auth["default"].required], _documentController["default"].getDocumentByFolderId);
router.post("/document-service/document", [_auth["default"].required], _documentController["default"].setDocument);
router.get("/document-service/document/:id", [_auth["default"].required], _documentController["default"].getDocumentById);
